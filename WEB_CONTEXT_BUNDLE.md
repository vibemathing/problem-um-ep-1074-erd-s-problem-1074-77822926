...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1074-erd-s-problem-1074-77822926-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1074"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1074-erd-s-problem-1074-77822926-v1",
      "problem_contract_sha256": "56b885199f39a7c3b7752e88d13a2eb9797f3a58e39204cace34096f915638ce",
      "problem_id": "problem:um-ep-1074-erd-s-problem-1074-77822926",
      "route_id": "route:um-ep-1074-erd-s-problem-1074-77822926-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1074-erd-s-problem-1074-77822926-source-fidelity-01",
      "graph_id": "graph:um-ep-1074-erd-s-problem-1074-77822926-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1074-erd-s-problem-1074-77822926-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1074-erd-s-problem-1074-77822926-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $S$ be the set of all $m\\geq 1$ such that there exists a prime $p ot\\equiv 1\\pmod{m}$ such that $m!+1\\equiv 0\\pmod{p}$. Does $ \\lim \\frac{\\lvert S\\cap [1,x]\\rvert}{x} $ exist? What is it? Similarly, if $P$ is the set of all primes $p$ such that there exists an $m$ with $p ot\\equiv 1\\pmod{m}$ such that $m!+1\\equiv 0\\pmod{p}$, then does $ \\lim \\frac{\\lvert P\\cap [1,x]\\rvert}{\\pi(x)} $ exist? What is it?"
          },
          "statement_sha256": "8abfb0321e230e8b8e343bf953fafdf6bc5c9170992280021b6c111d9e64414e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1074-erd-s-problem-1074-77822926-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1074-erd-s-problem-1074-77822926-root",
      "route_id": "route:um-ep-1074-erd-s-problem-1074-77822926-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1074-bac493310158",
        "url": "https://www.unsolvedmath.com/problems/EP-1074"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
